$(document).ready(function () {
  ...
  function populatePortfolio() {
      ...
      var projcard1 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='./show spotter.png'></div><div class='card-content'><span style='font-size:1.40em;' class='card-title white-text red'>Show Spotter</span><p class='card-textcontent'>A search engine were you can find events within a given radius.</p></div><a style='font-size:1.40em;padding:1px;' class='red-text' href='https://show-spotter.herokuapp.com' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 30px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/estomm01' target='_blank'>GitHub</a></p></div></div>");

      var projcard2 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='./crystal3.png'><span style='font-size:1.40em;' class='card-title white-text red'>Crystal-Unit-4-Game</span></div><div class='card-content'><p class='card-textcontent'>A web application game. </p></div><a style='font-size:1.40em;padding: 1px;' class='red-text' href='https://estomm01.github.io/unit-4-game/' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/estomm01' target='_blank'>GitHub</a></p></div></div>");

      var projcard3 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='./train4.png'><span style='font-size:1.40em;' class='card-title white-text red'>Train Scheduler</span></div><div class='card-content'><p class='card-textcontent'>An application</p></div><a style='font-size:1.40em;padding:1px;' class='red-text' href='https://estomm01.github.io/Train-Scheduler/' target='_blank'>View Project</a></div></div>");

      var projcard4 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='./giffy1.png'><span style='font-size:1.40em;' class='card-title white-text red'>Giftastic Web App</span></div><div class='card-content'><p class='card-textcontent'>A web page using the GIPHY API to generate button categories which then generate gifs</p></div><a style='font-size:1.40em;padding:1px;' class='red-text' href='https://estomm01.github.io/Giftastic/' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/estomm01/Giftastic-webpage' target='_blank'>GitHub</a></p></div></div>");
